...
# Единый тестовый номер для стабильной трассировки заявок в CRM.
# При необходимости можно переопределить через env TEST_PHONE_VALUE.
PHONE_TEST_VALUE = os.getenv("TEST_PHONE_VALUE", "1111111111")
PHONE_RETRY_VALUE = PHONE_TEST_VALUE
